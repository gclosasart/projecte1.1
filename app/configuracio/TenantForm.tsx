  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={pending}
        className="mt-2 self-start rounded-full bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-indigo-500 disabled:opacity-50 dark:bg-indigo-500 dark:text-white dark:hover:bg-indigo-400"
      >
