...
export function SelectorIdioma({ actual, textos }: { actual: Idioma; textos: Dict["comu"]["idiomes"] }) {
  ...
  return (
    <select
      ...
      aria-label="Idioma"
      className="rounded-full border border-black/10 bg-white px-3 py-1.5 text-sm text-zinc-950 outline-none focus:border-teal-600 disabled:opacity-50 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-50"
    >
