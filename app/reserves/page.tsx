  ...
  return (
    <div className="flex flex-1 flex-col bg-zinc-50 dark:bg-black">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-6 py-8 sm:flex-row sm:items-start">
        <Link
          href="/reserves/nova"
          className="flex flex-1 flex-col gap-1 rounded-xl border border-black/10 bg-white p-6 transition-colors hover:border-indigo-600 dark:border-white/10 dark:bg-zinc-950 dark:hover:border-indigo-500"
        >
