  ...
  return (
    <>
      <input
        ...
        className="mb-6 w-full rounded-lg border border-black/5 bg-white px-3 py-2 text-sm text-zinc-950 shadow-sm outline-none focus:border-teal-600 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-50"
      />
