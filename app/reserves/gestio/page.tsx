  ...
  return (
    <div className="flex flex-1 flex-col bg-neutral-50 dark:bg-black">
      ...
      <main className="mx-auto w-full max-w-screen-2xl flex-1 px-6 py-10">
        <Link
          href="/reserves/nova"
          className="mb-6 inline-block rounded-full bg-rose-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-rose-700 hover:shadow-md dark:bg-rose-500 dark:text-white dark:hover:bg-rose-400"
        >
