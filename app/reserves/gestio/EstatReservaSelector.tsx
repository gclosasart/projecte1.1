...
export function EstatReservaSelector({
  ...
  return (
    <select
      ...
      className="rounded-full border border-black/10 bg-white px-2 py-0.5 text-xs text-zinc-950 outline-none focus:border-sky-600 disabled:opacity-50 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-50"
    >
      {ESTATS.map((estat) => (
